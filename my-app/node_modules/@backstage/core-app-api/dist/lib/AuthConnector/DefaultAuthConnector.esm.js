...
class DefaultAuthConnector {
  ...
  constructor(options) {
    ...
    console.log('configApi.getOptionalBoolean:', configApi?.getOptionalBoolean("enableExperimentalRedirectFlow"));
    // console.log('configApi.getConfigData():', configApi?.getConfigData());

    this.enableExperimentalRedirectFlow = configApi ? configApi.getOptionalBoolean("enableExperimentalRedirectFlow") ?? false : false;
    console.log('-------------6', this.enableExperimentalRedirectFlow)
